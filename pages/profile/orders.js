    ...
    return (
        <div className='my-orders-page my-10'>
            <div className="container">
                ...
                {/* CURRENT ORDER */}
                <div className="p-6 bg-white rounded-lg mb-16">
                        ...
                        <div className="left-side">
                            ...
                            <div className="bg-slate-200 rounded-lg p-4 flex justify-between gap-8 lg:gap-16">
                                ...
                                <div className="flex-1 font-medium">
                                    ...
                                    <p className='text-slate-500 text-sm my-1'>1kg</p>
                                    <p className='flex items-center'><BiRupee /> 1584</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-3 gap-4 mt-4">
                                <button className='bg-red-400 rounded-lg p-2 px-4 text-white'>cancel order</button>
                                <button className='bg-slate-200 rounded-lg p-1 px-4 text-black'>Need help?</button>
                                <button className='bg-slate-200 rounded-lg p-1 px-4 text-black cursor-not-allowed' disabled>Download Invoice</button>
                            </div>
                        </div>

                        <div className="right-side mt-4 lg:mt-0">
                            <h1 className=" font-semibold mb-4">Shipping Details</h1>
                            <p className="text-sm text-slate-500">Building No,66, 78th Main Road, 100ft Road, Indiranagar, Bangalore 123456 Mobile: 98765 43210</p>

                            <h1 className=" font-semibold mb-4 mt-6">Shipping Details</h1>
                            <table className='w-full lg:w-6/12 text-sm text-slate-500'>
                                <tbody>
                                    <tr>
                                        <td>Sub Total : </td>
                                        <td>12455</td>
                    ...
                    {/* ORDER TIMELINE */}
                    <div className="grid grid-cols-4 mt-20 relative text-xs order-timeline">
                        ...
                        <div className="col">
                            ...
                            <h1>Order placed</h1>
                            <p className="lg:text-sm text-slate-500">Mon, 28th Mar 2022</p>
                        </div>
                ...
                <div className="past-order bg-white p-4 rounded-lg grid grid-cols-12 my-4 gap-4 lg:gap-0">
                    ...
                    <div className="col col-span-9 lg:col-span-7">
                        ...
                        <p className="text-sm text-slate-600 my-1">1 Kg</p>
                        <p className='flex items-center'><BiRupee /> 1584</p>
