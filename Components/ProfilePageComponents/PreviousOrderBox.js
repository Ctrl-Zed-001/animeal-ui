    ...
    return (
        <div className="past-order bg-slate-100 py-2 rounded-lg grid grid-cols-12 my-4 gap-4 lg:gap-0 text-xs px-4">
            <div className="col col-span-9 lg:col-span-7">
                <h1 className='font-semibold'>Order Id : {props.order.order_id}</h1>
                ...
                <div className="block lg:hidden text-xs">
                    <h1 className='my-2 font-medium'>Order placed on {props.order.purchased_date}</h1>
            ...
            <div className='col-span-4 hidden lg:block'>
                <h1 className='mb-4 font-medium'>Order placed on {dayjs(props.order.purchased_date).format("ddd, MMM DD YYYY")}</h1>
