    ...
    return (
        <Link href={{
            ...
            <div className='subcategory-box flex items-center p-3 rounded-lg cursor-pointer'>
                <img src={props.subcategory.category_icon == null ? '/img/category-placeholder.png' : `${process.env.NEXT_PUBLIC_IMAGE_URI}/category-icon/${props.subcategory.category_icon}`} alt="" className='h-20' />
