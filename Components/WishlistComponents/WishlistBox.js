        ...
        <div className='relative'>
            <a target="__blank" rel="noopener noreferrer" href={`/product/${props.product.product_slugname}`}>
                <div className="productbox rounded-xl border-2 border-white shadow cursor-pointer">
                    <img src={props.product.product_featured_image ? `${config.image_uri}/${props.product.product_id}/${props.product.product_featured_image}` : "/img/product-placeholder.png"} alt="" className='rounded-lg lg:h-48 mx-auto transform z-10' />
